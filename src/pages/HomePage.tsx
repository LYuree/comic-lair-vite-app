        ...
        <>
            ...
            <Container>
                <div className="relative bg-black flex justify-between items-center p-8 my-8">
                    <div className="text-white font-bold text-lg md:text-2xl lg:text-3xl">СКИДКА ДО 15% ЗА ПЕРВУЮ
                        ПОКУПКУ
                    </div>
                    <picture>
                        <source/>
                        <img src="/src/images/discount2.png" alt="discount 15%"
            ...
            <Container>
                <div className="relative bg-black flex justify-between items-center p-8 my-8">
                    <div className="text-white font-bold text-lg md:text-2xl lg:text-3xl">БЕСПЛАТНАЯ ДОСТАВКА ОТ 2000Р
                    </div>
                    <picture>
                        <source/>
            ...
            <Container>
                <div className="relative bg-black flex justify-between items-center p-8 my-8">
                    <div className="text-white font-bold text-lg md:text-2xl lg:text-3xl">Будьте в курсе новостей:
                        важнейшие акции и релизы
                    </div>
                    <button className="relative inline-block font-medium group py-2 px-4">
                        <span
                            className="absolute inset-0 w-full h-full transition duration-400 ease-out transform translate-x-1 translate-y-1 bg-[#ffbc13] group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
