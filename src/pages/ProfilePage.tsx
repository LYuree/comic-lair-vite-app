...
const ProfilePage: FC = observer(() => {
  ...
  return (
    <>
      ...
      <h1 className="text-3xl font-bold my-12 text-center">Личный кабинет</h1>
                ...
                <Card elevation={3} sx={{ mb: 3 }}>
                  <CardContent>
                    ...
                    >
                      ...
                      <Typography variant="h6">{currentUser.sub}</Typography>
                      ...
                      <>
                        <Box component="ul" sx={{ p: 0, mb: 3 }}>
                          {userOrderDetails
                            ...
                            // .map((order: Order) => (
                            .map((order: IOrderJSON) => {
                              console.log(order);
                              // const orderDetails = JSON.parse(
                              //   order.order_details
                              //   // '{"phone":"+79802176630","email":"slymerrow@gmail.com","cartProducts":{"data":[{"id":1,"name":"Ipsum-Man: The Long Way Home #1","description":"Short Description","price":1299,"discount":0.3,"hit":true,"releaseDate":null,"brand":"Grim Horse","digital":false,"categories":["Печатная книга","Комикс"],"cover_type":"Мягкая обложка","cover_image":"https://iili.io/FOsbVf4.webp","amount":1,"reviews":["review #1","review #2"]},{"id":2,"name":"The Return Of Lorem-Man","description":"Short Description","price":1499,"discount":0.15,"hit":false,"releaseDate":null,"brand":"Barbell","digital":true,"categories":["Электронная книга","Комикс"],"cover_type":null,"cover_image":"https://iili.io/FOsbaRt.webp","amount":1,"reviews":["review #1","review #2","review #3"]}]}}'
                              // );
                              return (
                                <Paper
                                  key={order.id}
                        ...
                        >
                          <Pagination
                            count={Math.ceil(
                              userOrderDetails.length / itemsPerPage
                            )}
                            page={page}
