        ...
        <>
          ...
          !cartProducts.data.length ? (
            <div className="w-full h-[80vh] flex flex-col justify-center items-center gap-4">
              ...
              <a
                className="bg-blue-500 text-white px-4 py-2 hover:bg-blue-600 inline-block"
                href="/"
              >
                  ...
                  <div className="flex py-8">
                    <div className="bg-white w-96 mx-auto sm:mx-0">
                      ...
                      <form>
                        ...
                        >
                          <span className="w-full h-48 bg-[maroon] absolute bottom-0 left-0 translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
