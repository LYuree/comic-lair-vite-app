        ...
        <div className="timeline">
            <div className="bound-layout">
                <div className="timeline-row">
                    <div className="image">
                        <img src="/src/images/friends_1.jpg" alt="" />
                    </div>
                    <div className="content">
                        <h1 className="text-3xl font-bold mb-4">Everything started with a group of dreamers...</h1>
                ...
                <div className="timeline-row reverse">
                    ...
                    <div className="content">
                        <h1 className="text-3xl font-bold mb-4">A Happy Acquaintance</h1>
                ...
                <div className="timeline-row">
                    <div className="image">
                        <img src="/src/images/bonefire_3.jpg" alt="" />
                    </div>
                    <div className="content">
                        <h1 className="text-3xl font-bold">A Bonfire In The Shop</h1>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                    </div>
                </div>
                <div className="timeline-row reverse">
                    ...
                    <div className="content">
                        <h1 className="text-3xl font-bold">We Were Always Told To nEvA gIvE uPpP!11!!!</h1>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                    </div>
                </div>
                <div className="timeline-row">
                    ...
                    <div className="content">
                        <h1 className="text-3xl font-bold">So We Worked Seven Times As Hard As Before...</h1>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                    </div>
                </div>
                ...
                <div className="text-center my-16">
                    ...
                    <p className="text-3xl my-4">And we seek to provide you with the best deals in the world of drawn stories.</p>
